# EU AI Act — Yashigani 4.1.2 — NOT ASSESSED
...
|---|---|---|
| AI-9.2 | Known and foreseeable risks identified and analysed | NOT ASSESSED |
| AI-9.3 | Residual risks estimated and judged acceptable | NOT ASSESSED |
| AI-9.4 | Risk mitigation measures adopted | NOT ASSESSED |
| AI-9.5 | Testing for risk management — appropriate measures for identified risks | NOT ASSESSED |
| AI-10.1 | Data governance and management practices established | NOT ASSESSED |
| AI-10.2 | Training data relevance, representativeness, and accuracy | NOT ASSESSED |
| AI-10.3 | Bias examination and mitigation in datasets | NOT ASSESSED |
| AI-10.4 | PII processing compliant with data protection law | NOT ASSESSED |
| AI-11.1 | Technical documentation drawn up before placing on market | NOT ASSESSED |
| AI-11.2 | Documentation includes system description and intended purpose | NOT ASSESSED |
| AI-11.3 | Documentation includes model architecture and training details | NOT ASSESSED |
| AI-12.1 | Automatic logging of events during AI system operation | NOT ASSESSED |
| AI-12.2 | Logs enable traceability of AI system functioning | NOT ASSESSED |
| AI-12.3 | Log retention appropriate for intended purpose | NOT ASSESSED |
| AI-13.1 | AI system designed for transparency and interpretability | NOT ASSESSED |
| AI-13.2 | Instructions for use provided to deployers | NOT ASSESSED |
| AI-13.3 | Known limitations and performance metrics disclosed | NOT ASSESSED |
| AI-14.1 | AI system designed for effective human oversight | NOT ASSESSED |
| AI-14.2 | Human ability to override or reverse AI decisions | NOT ASSESSED |
| AI-14.3 | Kill switch / emergency stop capability | NOT ASSESSED |
| AI-14.4 | Human oversight measures documented | NOT ASSESSED |
| AI-15.1 | AI system achieves appropriate level of accuracy | NOT ASSESSED |
| AI-15.2 | AI system resilient to errors, faults, and inconsistencies | NOT ASSESSED |
| AI-15.3 | Adversarial robustness against manipulation | NOT ASSESSED |
| AI-15.4 | Cybersecurity measures appropriate to risks | NOT ASSESSED |
| AI-15.5 | Protection against unauthorised access to training data and model | NOT ASSESSED |
| AI-26.1 | Deployer uses AI system in accordance with instructions for use | NOT ASSESSED |
| AI-26.3 | Deployer monitors AI system operation and reports serious incidents | NOT ASSESSED |
| AI-50.1 | AI-generated content marked as artificially generated | NOT ASSESSED |
| AI-50.2 | Users informed they are interacting with an AI system | NOT ASSESSED |
| AI-50.3 | Deep fake content clearly labelled | NOT ASSESSED |
