# OWASP API Security Top 10 (2023) — Yashigani 4.1.2 — NOT ASSESSED
...
|---|---|---|
| API2 | Broken Authentication — token authentication is used | NOT ASSESSED |
| API4 | Unrestricted Resource Consumption — rate limiting applied to endpoints | NOT ASSESSED |
| API5 | Broken Function Level Authorization — admin endpoints guarded | NOT ASSESSED |
| API7 | Server-Side Request Forgery — outbound URLs validated against allowlist | NOT ASSESSED |
| API8 | Security Misconfiguration — CORS allowed origins explicitly set | NOT ASSESSED |
| API9 | Improper Inventory Management — API versioning present | NOT ASSESSED |
| API10 | Unsafe Consumption of APIs — responses from third-party APIs validated | NOT ASSESSED |
