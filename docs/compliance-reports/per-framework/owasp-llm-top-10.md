# OWASP LLM Top 10 — Yashigani 4.1.2 — NOT ASSESSED
...
|---|---|---|
| LLM01 | Prompt Injection | NOT ASSESSED |
| LLM02 | Sensitive Information Disclosure | NOT ASSESSED |
| LLM03 | Supply Chain | NOT ASSESSED |
| LLM04 | Data and Model Poisoning | NOT ASSESSED |
| LLM05 | Improper Output Handling | NOT ASSESSED |
| LLM06 | Excessive Agency | NOT ASSESSED |
| LLM07 | System Prompt Leakage | NOT ASSESSED |
| LLM08 | Vector and Embedding Weaknesses | NOT ASSESSED |
| LLM09 | Misinformation | NOT ASSESSED |
| LLM10 | Unbounded Consumption | NOT ASSESSED |
