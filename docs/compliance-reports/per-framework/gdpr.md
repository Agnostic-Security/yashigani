# GDPR — Yashigani 4.1.2 — NOT ASSESSED
...
|---|---|---|
| Art.5.1.e | Storage limitation — kept no longer than necessary (retention policy) | NOT ASSESSED |
| Art.17 | Right to erasure — deletion endpoint or DSAR handler present | NOT ASSESSED |
| Art.20 | Right to data portability — machine-readable export available | NOT ASSESSED |
| Art.25 | Data protection by design and by default — privacy-preserving defaults | NOT ASSESSED |
| Art.30 | Records of processing activities (RoPA) — audit log of PII-touching operations | NOT ASSESSED |
