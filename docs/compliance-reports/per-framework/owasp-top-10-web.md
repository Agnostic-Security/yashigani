# OWASP Web Application Top 10 (2021) — Yashigani 4.1.2 — NOT ASSESSED
...
|---|---|---|
| A02 | Cryptographic Failures — no weak or deprecated algorithms | NOT ASSESSED |
| A03 | Injection — SQL queries must be parameterised | NOT ASSESSED |
| A05 | Security Misconfiguration — debug mode off in production | NOT ASSESSED |
| A06 | Vulnerable and Outdated Components — dependency lock file present | NOT ASSESSED |
| A07 | Authentication Failures — rate limiting present on login endpoints | NOT ASSESSED |
| A08 | Software Integrity — signing or hash verification mechanism present | NOT ASSESSED |
| A09 | Security Logging — authentication events are logged | NOT ASSESSED |
| A10 | Server-Side Request Forgery — outbound HTTP calls use an allowlist | NOT ASSESSED |
