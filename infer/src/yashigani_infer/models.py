...
Every :class:`~yashigani_infer.adapters.base.SourceAdapter` resolves to a
...
class ProvenanceKind(str, Enum):
    ...
    :mod:`yashigani_infer.adapters.convert`).
    """
...
class ResolvedModel:
    ...
    Attributes:
        ...
        metadata: Normalized metadata dict, typically produced by
            :func:`yashigani_infer.gguf.header.parse_gguf_header` plus
