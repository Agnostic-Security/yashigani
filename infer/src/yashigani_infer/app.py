...
(`Caddyfile.infer-front`), not here.
...
from yashigani_infer.containment.hooks import OutputInspectionHook, noop_output_inspection_hook
from yashigani_infer.models import ResolvedModel
from yashigani_infer.shim.chat import chat_event_to_ndjson, translate_chat_request
from yashigani_infer.shim.embeddings import translate_embeddings_request, translate_embeddings_response
from yashigani_infer.shim.framing import SSE_DONE_SENTINEL
from yashigani_infer.shim.generate import generate_event_to_ndjson, translate_generate_request
...
from yashigani_infer.shim.tags import synthesize_tags
from yashigani_infer.supervisor.supervisor import LoadConfig, ResourceLimitExceeded, Supervisor
...
def create_app(
    *,
    ...
    """Build the yashigani-infer HTTP app.
    ...
    """
    app = FastAPI(title="yashigani-infer", version="0.1.0")
