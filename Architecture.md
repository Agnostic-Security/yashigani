...
The current release narrative (v2.24.0 through v2.25.3.1) is in the [README](README.md#current-release-highlights). This section preserves the full per-version history.
