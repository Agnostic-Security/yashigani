...
- **AI1 — Prompt Injection:** ✅ **IMPLEMENTED** — Three-layer defense: (1) regex pattern detection (v2.0+), (2) scikit-learn ML classifier (TF-IDF + LogisticRegression, sub-5ms, offline v2.23.3+), (3) KUROSHIO LLM-based deep inspection (v5.0 / roadmap). Multi-LLM adjudication on OPA routing safety net (fail-closed v2.0+). Bidirectional protection on request and response paths (v2.20+).
